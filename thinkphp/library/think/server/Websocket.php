...
class SwooleServer
{
    ...
    public function __construct($config)
    {
        ...
        $this->_server = new \Swoole\WebSocket($config['ip'], $config['port'], $config['mode'] ?? SWOOLE_BASE);
     ...
     *
     */
    public function onRequest(\Swoole\WebSocket\Request $request, \Swoole\WebSocket\Response $response): void
    {
        //请求过滤,会请求2次
     ...
     */
    public static function shutdown(\Swoole\WebSocket\Server $server)
    {
        //实例启动后执行
